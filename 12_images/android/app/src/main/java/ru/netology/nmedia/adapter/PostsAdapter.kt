...
interface OnInteractionListener {
    ...
    fun onShowImage(attachmentUrl:String){}
}
        ...
        binding.apply {
            ...
            if(post.attachment?.type == IMAGE){
               imageContent.visibility = View.VISIBLE
                imageContent.loadFitCenter("${BuildConfig.BASE_URL}/media/${post.attachment.url}")
            ...
            imageContent.setOnClickListener {
             onInteractionListener.onShowImage(post.attachment?.url!!)
            }
